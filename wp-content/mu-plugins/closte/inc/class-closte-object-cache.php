...
if ($use_object_cache == true):
    ...
    function wp_cache_init()
    {
        ...
        $object_cache = new ApcuObjectCache();

        // set up multisite environments
        if (is_multisite())
        {
            $object_cache->set_multisite(true);
            $object_cache->set_blog_id((int)get_current_blog_id());
            $object_cache->set_transient_groups();
        }

        $wp_object_cache = $object_cache;
    ...
    class ApcuObjectCache
    {
        ...
        public function set_transient_groups():
            void
        {
